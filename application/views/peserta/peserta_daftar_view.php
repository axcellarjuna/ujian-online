...
<section class="content-header">
	<h1>
		Siswa
		<small>Daftar Siswa, Penambahan Siswa, Pengubahan Siswa, dan Penghapusan Siswa</small>
	</h1>
	<ol class="breadcrumb">
        ...
        <div class="col-md-3">
                <div class="box">
                    ...
                    <div class="box-footer">
                        <p>Pilih Kelas terlebih dahulu untuk menampilkan dan menambah Siswa</p>
                    </div>
                </div>
        </div>
    ...
    <?php echo form_open($url.'/tambah','id="form-tambah"'); ?>
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button class="close" type="button" data-dismiss="modal">&times;</button>
                    <div id="trx-judul">Tambah Siswa</div>
                </div>
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class="box-body">
                    ...
                    <div class="row-fluid">
                        <div class="box-body">
							...
							<div class="form-group">
								...
								<p class="help-block">Dapat diisi Ruang dan Sesi Siswa. Contoh : Ruang 1, Sesi 1</p>
                            </div>
                            ...
                            <p>NB : Siswa yang dihapus, maka semua hasil tes akan ikut terhapus !</p>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
