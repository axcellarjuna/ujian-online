        ...
        <div class="col-md-6">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <p>Klik tombol <b>Backup Data Upload</b> untuk melakukan Backup Data yang di Upload (gambar, audio). Simpan backup data pada tempat yang aman.</p>
	...
	<div class="row">
		<div class="col-md-6">
                <div class="box">
                    ...
                    <div class="box-body">
                        <span id="form-pesan-database"></span>
                        <p>Klik tombol <b>Clear Sessions</b> untuk membersihkan sessions siswa ujian yang disimpan di tabel cbt_sessions.</p>
                        <p>Setelah Aplikasi Ujian Online digunakan dalam waktu yang lama dan menjalan banyak Ujian, maka session harus dibersikan.</p>
                        <p>Pastikan tidak ada siswa yang sedang melakukan Ujian saat session dibersihkan.</p>
