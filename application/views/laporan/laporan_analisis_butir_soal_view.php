...
<section class="content-header">
	<h1>
		Laporan Lihat Soal
		<small>Lihat Soal sesuai dengan Kelas dan Ujians yang dipilih</small>
	</h1>
	<ol class="breadcrumb">
	...
	<div class="row">
        <div class="col-md-12">
            <div class="callout callout-info">
                <h4>Informasi</h4>
                <p>Pilih Kelas Siswa dan Ujian untuk melihat soal.</p>
                <p>Urutan soal sesuai dengan urutan soal saat dilakukan input soal seperti pada Daftar Soal pada menu Modul.</p>
            </div>
        </div>
    </div>
		...
		<div class="col-sm-12">
			<div class="box">
				<div class="box-header with-border">
					<div class="box-title">Pilih Kelas dan Ujian</div>
				</div><!-- /.box-header -->
				...
				<div class="box-body">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<span class="help-block">Pilih Nama Ujian untuk melihat soal</span>
						</div>
					</div>
				</div>
