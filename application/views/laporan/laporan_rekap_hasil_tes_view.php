...
<section class="content-header">
	<h1>
		Rekap Hasil Ujian
		<small>Export Rekap Hasil Ujian ke Excel</small>
	</h1>
	<ol class="breadcrumb">
		<li><a href="<?php echo site_url(); ?>/"><i class="fa fa-dashboard"></i> Home</a></li>
		<li class="active">Rekap Hasil Ujian</li>
	</ol>
</section>
...
<section class="content">
	<div class="row">
        <div class="col-md-12">
            <div class="callout callout-info">
                <h4>Informasi</h4>
                <p>Pilih Kelas Siswa yang akan di export Hasil ujian nya pada bagian samping halaman ini, dan pilih rentang waktu ujian tersebut dikerjakan.</p>
                <p>Siswa yang tidak mengikuti Ujian, maka Hasilnya akan bernilai N/A pada file hasil Export.</p>
            </div>
        </div>
    </div>
	...
	<div class="row">
		...
		<div class="col-md-8">
            <div class="box">
				<div class="box-header with-border">
					<div class="box-title">Rekap Hasil Ujian</div>
    			</div><!-- /.box-header -->
				...
				<div class="box-body form-horizontal">
						<div class="form-group">
                            ...
                            <div class="col-sm-9">
								...
								<span class="help-block">Pilih Rentang Tanggal dimana Ujian dilakukan. Sesuai Waktu Mulai pada Daftar Ujian.</span>
                            </div>
                        </div>
                </div>
