...
<section class="content-header">
	<h1>
		Mata Pelajaran
		<small>Daftar Mata Pelajaran, Menambah, Mengubah, dan Menghapus berdasarkan Modul</small>
	</h1>
	<ol class="breadcrumb">
                    ...
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tambah-topik" name="tambah-topik" placeholder="Nama Mata Pelajaran">
                            </div>

                            <div class="form-group">
                                <label>Deskripsi</label>
                                <input type="text" class="form-control" id="tambah-deskripsi" name="tambah-deskripsi" placeholder="Deskripsi" >
                            </div>
