...
<section class="content-header">
	<h1>
		Mengelola Soal
		<small>Mengelola soal berdasarkan Modul dan Mata Pelajaran</small>
	</h1>
	<ol class="breadcrumb">
        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-footer">
                    <p>Pilih terlebih dahulu Mata Pelajaran sebelum menambah atau mengubah soal</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <p class="help-block">Memutar Audio sebanyak satu kali dalam satu Ujian</p>
                                </div>
                            </div>
                            <div class="form-group">
