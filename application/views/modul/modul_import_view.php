...
<section class="content-header">
	<h1>
		Mengimport Soal dari Microsoft Excel
		<small>Melakukan Import Soal dari  Excel berdasarkan Modul dan Mata Pelajaran</small>
	</h1>
	<ol class="breadcrumb">
        ...
        <div class="col-md-4">
            <div class="box">
                <div class="box-header with-border">
                    <div class="box-title">Pilih Mata Pelajaran</div>
                </div><!-- /.box-header -->
                ...
                <div class="box-footer">
                    <p>Pilih terlebih dahulu Mata Pelajaran yang akan digunakan sebelum melakukan import soal</p>
                </div>
            </div>
        </div>
		<div class="col-md-8">
			<div class="box">
                <div class="box-header with-border">
                    <div class="box-title">Import Soal dari Microsoft Excel</div>
