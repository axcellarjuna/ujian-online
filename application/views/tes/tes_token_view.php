...
<section class="content-header">
	<h1>
		Token
		<small>Membuat token untuk Ujian</small>
	</h1>
	<ol class="breadcrumb">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-xs-6">
							...
							<div class="form-group">
                                <label class="col-sm-3 control-label">Daftar Ujian</label>
                                <div class="col-sm-9">
                                    <select class="form-control input-sm" id="token-tes" name="token-tes">
                                        <?php if(!empty($select_tes)){ echo $select_tes; } ?>
                                    </select>
                                    <p class="help-block">Token dapat digunakan secara spesifik untuk suatu Ujian atau semua Ujian.</p>
                                </div>
                            </div> 
                        </div>
                        <div class="col-xs-3"></div>   
                    ...
                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary pull-right" id="import">Dapatkan Token</button>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div id="trx-judul">Token Ujian Manual</div>
                </div>
                    ...
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="form-group">
								...
								<span class="help-block">Pastikan Token Ujian Manual belum pernah digunakan pada hari yang sama.</span>
                            </div>
